            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-xl text-slate-600 mb-8 leading-relaxed max-w-xl">
                  Transform your living space into a peaceful yoga sanctuary. Our RYT-certified trainers bring 
                  personalized, premium yoga sessions directly to your doorstep.
                </p>
              </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <Card
                key={index}
                className="bg-white/60 backdrop-blur-sm border-0 shadow-lg rounded-3xl hover:shadow-2xl transition-all duration-500 group hover:-translate-y-2 overflow-hidden"
              >
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Getting started with your personalized yoga journey is simple and straightforward
            </p>
          </div>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              RYT-certified professionals with 500+ hours of training, dedicated to your wellness journey
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {featuredTrainers.map((trainer) => (
              <Card
                key={trainer.id}
                className="bg-white/60 backdrop-blur-sm border-0 shadow-lg rounded-3xl hover:shadow-2xl transition-all duration-500 overflow-hidden group hover:-translate-y-2"
              >
          ...
          <div className="text-center mt-12">
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-2 border-emerald-300 text-emerald-600 hover:bg-emerald-50 rounded-2xl px-8 py-4 font-semibold"
            >
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-emerald-400 via-blue-400 to-emerald-500 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg lg:text-xl text-white/90 mb-8">
            Join thousands of satisfied students who've elevated their mind, body, and spirit—right at home.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button
              asChild
              size="lg"
              className="bg-white text-emerald-600 hover:bg-white/90 rounded-2xl px-8 py-6 font-semibold shadow-lg transition"
            >
              <Link href="/booking" className="flex items-center gap-2">
                Book a Free Trial
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-2 border-white text-white hover:bg-white/20 rounded-2xl px-8 py-6 font-semibold transition"
            >
              <Link href="/trainers" className="flex items-center gap-2">
                Meet Our Trainers
